        ...
        <div style={{ overflowY: 'auto', flex: 1 }}>
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 12 }}>
            <thead style={{ position: 'sticky', top: 0, background: '#f8f8fc' }}>
              <tr>
                {['Content ID', 'Current Key', 'Content Title', 'Content Type', 'L2V', 'Duration (hrs)', 'MySQL Status', 'CB Status', 'Restoration Status', 'External ID', 'Current Updated', 'Previous Key', 'Video/Audio/Caption/Image Created Date'].map(h => (
