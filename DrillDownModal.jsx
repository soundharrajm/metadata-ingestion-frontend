        ...
        <div style={{ overflowY: 'auto', flex: 1 }}>
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 12 }}>
            <thead style={{ position: 'sticky', top: 0, background: '#f8f8fc' }}>
              <tr>
                {['Content ID', 'Current Key', 'Content Title', 'Content Type', 'L2V', 'Duration (hrs)', 'MySQL Status', 'CB Status', 'Restoration Status', 'Restoration File Type', 'External ID', 'File Name', 'Video Created Time', 'Encode Manifest Updated Time', 'Video-to-Encode Diff (hh:mm:ss)', 'Current Updated', 'Previous Key', 'Video/Audio/Caption/Image Created Date', 'Media File Type'].map(h => (
            ...
            <tbody>
              {items.map((r, i) => (
                <tr key={i}>
                  ...
                  <td style={{ padding: '7px 12px', borderBottom: `1px solid ${C.border}`, fontFamily: C.mono }}>{r.video_to_encode_diff || '—'}</td>
